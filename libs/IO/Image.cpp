...
bool CImage::FilterFormat(void *pDst,
                          PIXELFORMAT formatDst,
                          Size strideDst,
                          const void *pSrc,
                          PIXELFORMAT formatSrc,
                          Size strideSrc,
                          Size nSzize)
{
    ...
    case PF_GRAY8:
        ...
        case PF_GRAY8:
            ...
            for (Size i = 0; i < nSzize;
                 ++i, (uint8_t *&)pDst += strideDst, (uint8_t *&)pSrc += strideSrc)
        ...
        case PF_R8G8B8:
            ...
            for (Size i = 0; i < nSzize;
                 ++i, (uint8_t *&)pDst += strideDst, (uint8_t *&)pSrc += strideSrc)
                ((uint8_t *)pDst)[0] = RGB24TO8(((uint8_t *)pSrc)[2],
                                                ((uint8_t *)pSrc)[1],
                                                ((uint8_t *)pSrc)[0]);
            return true;
        }
    ...
    case PF_R5G6B5:
        ...
        case PF_GRAY8:
            ...
            for (Size i = 0; i < nSzize;
                 ++i, (uint8_t *&)pDst += strideDst, (uint8_t *&)pSrc += strideSrc)
                *((uint16_t *)pDst) = RGB24TO16(((uint8_t *)pSrc)[0],
                                                ((uint8_t *)pSrc)[0],
                                                ((uint8_t *)pSrc)[0]);
            return true;
        ...
        case PF_R8G8B8A8:
            ...
            for (Size i = 0; i < nSzize;
                 ++i, (uint8_t *&)pDst += strideDst, (uint8_t *&)pSrc += strideSrc)
                *((uint16_t *)pDst) = RGB24TO16(((uint8_t *)pSrc)[2],
                                                ((uint8_t *)pSrc)[1],
                                                ((uint8_t *)pSrc)[0]);
            return true;
        ...
        case PF_A8R8G8B8:
            ...
            for (Size i = 0; i < nSzize;
                 ++i, (uint8_t *&)pDst += strideDst, (uint8_t *&)pSrc += strideSrc)
                *((uint16_t *)pDst) = RGB24TO16(((uint8_t *)pSrc)[3],
                                                ((uint8_t *)pSrc)[2],
                                                ((uint8_t *)pSrc)[1]);
            return true;
        ...
        case PF_A8B8G8R8:
            ...
            for (Size i = 0; i < nSzize;
                 ++i, (uint8_t *&)pDst += strideDst, (uint8_t *&)pSrc += strideSrc)
                *((uint16_t *)pDst) = RGB24TO16(((uint8_t *)pSrc)[1],
                                                ((uint8_t *)pSrc)[2],
                                                ((uint8_t *)pSrc)[3]);
            return true;
        }
...
{
    const String strName = Util::getFileName(szFileName) + String::ToString(m_width) + _T("x")
                           + String::ToString(m_height) + _T("x") + String::ToString(m_stride)
                           + Util::getFileExt(szFileName);
