...
bool Application::Initialize(size_t argc, LPCTSTR *argv)
{
    ...
    generic
        .add_options()("help,h",
                       "produce this help message")("working-folder,w",
                                                    boost::program_options::value<std::string>(&WORKING_FOLDER),
                                                    "working directory (default current "
                                                    "directory)")("config-file,c",
                                                                  boost::program_options::value<
                                                                      std::string>(&OPT::strConfigFileName)
                                                                      ->default_value(APPNAME
                                                                                      _T(".cfg")),
                                                                  "file name containing program "
                                                                  "options")("export-type",
                                                                             boost::program_options::value<
                                                                                 std::string>(&OPT::strExportType)
                                                                                 ->default_value(_T("ply")),
                                                                             "file type used to "
                                                                             "export the 3D scene "
                                                                             "(ply, obj, glb or "
                                                                             "gltf)")("archive-"
                                                                                      ...
                                                                                      boost::program_options::
                                                                                          value(&OPT::nArchiveType)
                                                                                              ->default_value(ARCHIVE_MVS),
                                                                                      "project "
                                                                                      "archive "
                                                                                      "type: "
                                                                                      "-1-"
            ...
            ("verbosity,v",
             ...
             "verbosity level")
                ...
                ("cuda-device",
                 ...
                 "CUDA device number to be used to texture the mesh (-2 - CPU processing, -1 - "
    ...
    config.add_options()("input-file,i",
                         ...
                         "input filename containing camera poses and image list")("mesh-file,m",
                                                                                  boost::program_options::value<
                                                                                      std::string>(&OPT::strMeshFileName),
                                                                                  "mesh file name "
                                                                                  "to texture "
                                                                                  "(overwrite "
                                                                                  "existing mesh)")("output-file,o",
                                                                                                    boost::program_options::value<
                                                                                                        std::string>(&OPT::strOutputFileName),
                                                                                                    "output filename for storing the mesh")("decimate",
                                                                                                                                            boost::program_options::
                                                                                                                                                value(&OPT::fDecimateMesh)
                                                                                                                                                    ->default_value(1.f),
                                                                                                                                            "decimation factor in range [0..1] to be applied to the input surface before "
                                                                                                                                            "refinement (0 - auto, 1 - disabled)")(
        "close-holes",
        boost::program_options::value(&OPT::nCloseHoles)->default_value(30),
        "try to close small holes in the input surface "
        "(0 - disabled)")("resolution-level",
                          boost::program_options::value(&OPT::nResolutionLevel)->default_value(0),
                          "how many times to scale "
                          "down the images before "
                          "mesh refinement")("min-"
                                             "resolut"
                                             "ion",
                                             boost::program_options::value(&OPT::nMinResolution)
                                                 ->default_value(640),
                                             "do not "
                                             "scale "
                                             "images "
                                             ...
                                             "this "
                                             "resolut"
                                             "ion")("outlier-threshold",
                                                    boost::program_options::value(&OPT::fOutlierThreshold)
                                                        ->default_value(6e-2f),
                                                    "threshold used to find and remove outlier "
                                                    "face textures (0 "
                                                    "- disabled)")("cost-smoothness-ratio",
                                                                   boost::program_options::value(&OPT::fRatioDataSmoothness)
                                                                       ->default_value(0.1f),
                                                                   "ratio used to adjust the "
                                                                   "preference for more "
                                                                   "compact patches (1 - best "
                                                                   "quality/worst "
                                                                   "compactness, ~0 - worst "
                                                                   "quality/best "
                                                                   "compactness)")("virtual-face-"
                                                                                   "images",
                                                                                   boost::program_options::
                                                                                       value(&OPT::minCommonCameras)
                                                                                           ->default_value(0),
                                                                                   "generate "
                                                                                   "texture "
                                                                                   "patches "
                                                                                   ...
                                                                                   "views (0 - "
                                                                                   "disabled, 3 - "
                                                                                   "good value)")("global-seam-"
                                                                                                  "leveling",
                                                                                                  boost::program_options::
                                                                                                      value(&OPT::bGlobalSeamLeveling)
                                                                                                          ->default_value(true),
                                                                                                  "generate "
                                                                                                  "uniform "
                                                                                                  "texture "
                                                                                                  "patches using "
                                                                                                  "global seam "
                                                                                                  "leveling")("local-seam-leveling",
                                                                                                              boost::program_options::
                                                                                                                  value(&OPT::bLocalSeamLeveling)
                                                                                                                      ->default_value(true),
                                                                                                              "generate uniform texture "
                                                                                                              "patch borders using local "
                                                                                                              "seam leveling")(
        "texture-"
        "size-"
        "multiple",
        boost::program_options::value(&OPT::nTextureSizeMultiple)->default_value(0),
        "texture "
        "size "
        "should be "
        "a multiple "
        ...
        "two)")("patch-packing-"
                "heuristic",
                boost::program_options::value(&OPT::nRectPackingHeuristic)->default_value(3),
                "specify the "
                "heuristic used when "
                "deciding where to "
                "place a new patch "
                ...
                "best speed)")("empty"
                               "-colo"
                               "r",
                               boost::program_options::value(&OPT::nColEmpty)->default_value(0x00FF7F27),
                               "color"
                               " used"
                               " for "
                               "faces"
                               ...
                               "e")("sharpness-"
                                    "weight",
                                    boost::program_options::value(&OPT::fSharpnessWeight)
                                        ->default_value(0.5f),
                                    "amount of "
                                    "sharpness to "
                                    "be applied "
                                    "on the "
                                    "texture (0 - "
                                    "disabled)")("orthographic-image-resolution",
                                                 boost::program_options::value(&OPT::nOrthoMapResolution)
                                                     ->default_value(0),
                                                 "orthographic image resolution to be generated "
                                                 "from "
                                                 "the textured mesh - the mesh is expected to be "
                                                 "already geo-referenced or at least properly "
                                                 "oriented "
                                                 "(0 - disabled)")("ignore-mask-label",
                                                                   boost::program_options::value(&OPT::nIgnoreMaskLabel)
                                                                       ->default_value(-1),
                                                                   "label value to ignore in the "
                                                                   "image "
                                                                   "mask, stored in the MVS scene "
                                                                   "or "
                                                                   "next to each "
                                                                   "image "
                                                                   "with '.mask.png' extension (-1 "
                                                                   "- "
                                                                   "auto estimate mask for lens "
                                                                   "distortion, -2 - "
                                                                   "disabled)")("max-texture-size",
                                                                                boost::program_options::
                                                                                    value(&OPT::nMaxTextureSize)
                                                                                        ->default_value(8192),
                                                                                "maximum texture "
                                                                                "size, "
                                                                                "split it in "
    ...
    hidden.add_options()("views-file",
                         boost::program_options::value<std::string>(&OPT::strViewsFileName),
                         "file name containing the list of views to be used for texturing "
                         "(optional)");
    ...
    OPT::strOutputFileName = "E:/OpenMVS_Windows_x64/111.mvs";
...
int main(int argc, LPCTSTR *argv)
{
...

    {
        ...
        if (OPT::fDecimateMesh < 1.f)
        {
            ...
            scene.mesh.Clean(1.f, 0.f, false, 0u, 0u, 0.f, true); // extra cleaning to remove non-manifold
        ...
        if (!scene.TextureMesh(OPT::nResolutionLevel,
                               ...
                               views))
            return EXIT_FAILURE;
        VERBOSE("Mesh texturing completed: %u vertices, %u faces (%s)",
